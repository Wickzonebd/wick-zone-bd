...
import { Activity, BadgeCheck, BriefcaseBusiness, Check, CircleDollarSign, FileCheck2, Gift, ImagePlus, LayoutDashboard, LockKeyhole, Megaphone, Newspaper, Palette, Plus, RefreshCw, Search, Settings, ShieldCheck, ShoppingBag, Sparkles, Trash2, UploadCloud, UserRound, UsersRound, WalletCards, X } from "lucide-react";
...
type AdminTab = "dashboard" | "users" | "services" | "jobs" | "proofs" | "withdrawals" | "posts" | "reports" | "content" | "settings" | "audit";
