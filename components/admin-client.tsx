...
import { Activity, BadgeCheck, BriefcaseBusiness, Check, CircleDollarSign, FileCheck2, FileText, Gift, ImagePlus, LayoutDashboard, LockKeyhole, Megaphone, Newspaper, Palette, Plus, RefreshCw, Search, Settings, ShieldCheck, ShoppingBag, Sparkles, Store, Trash2, Trophy, UploadCloud, UserRound, UsersRound, WalletCards, X } from "lucide-react";
