...
import { Edit3, ImageIcon, Layers3, PackageOpen, Plus, RefreshCw, Store, ToggleLeft, ToggleRight, Trash2, X } from "lucide-react";
...
export function AdminResellingManager({ currency }: { currency: string }) {
  ...
  const reset = () => {
    setProductDraft({ ...emptyProduct }); setCategoryDraft({ ...emptyCategory }); setVendorDraft({ ...emptyVendor }); setBannerDraft({ ...emptyBanner }); setEditingId(null);
  };
