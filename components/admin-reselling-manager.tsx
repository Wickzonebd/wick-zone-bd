...
export function AdminResellingManager({ currency }: { currency: string }) {
  ...
  const reset = () => {
    setProductDraft({ ...emptyProduct }); setProductImageFile(null); setCategoryDraft({ ...emptyCategory }); setCategoryImageFile(null); setVendorDraft({ ...emptyVendor }); setVendorLogoFile(null); setBannerDraft({ ...emptyBanner }); setEditingId(null);
  };
